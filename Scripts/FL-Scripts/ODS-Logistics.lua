...
local function EnemyAttackers()
    ...
    SPAWN:NewWithAlias('TND1', '[UK] No17 Squadron Tornado'):InitLimit(2, 16):SpawnScheduled(1300, 0.3)
        :InitRepeatOnLanding()

    SPAWN:NewWithAlias('TND2', '[Italy] Legion 15 Tornado'):InitLimit(2, 16):SpawnScheduled(1300, 0.3)
        :InitRepeatOnLanding()
end
